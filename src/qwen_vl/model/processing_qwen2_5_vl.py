...
from .point3r.point3r import LocalMemory
...
class Qwen2_5_VLPointersKwargs(TypedDict, total=False):
    patch_size: Optional[int]
...
class Qwen2_5_VLProcessorKwargs(ProcessingKwargs, total=False):
    ...
    pointers_kwargs: Qwen2_5_VLPointersKwargs
    _defaults = {
        "text_kwargs": {
            "padding": False,
        },
...
class Qwen2_5_VLProcessorWithPoint3R(Qwen2_5_VLProcessor):
    r"""
    Constructs a Qwen2.5-VL processor with Point3R Memory. We assume that Vision-encoded features is already stored in the pointer.
    Args:
        image_processor ([`Qwen2VLImageProcessor`], *optional*):
            The image processor is a required input.
        tokenizer ([`Qwen2TokenizerFast`], *optional*):
    ...
    def __init__(self, image_processor=None, tokenizer=None, chat_template=None, **kwargs):
        ...
        # TODO: consider adding this line to the model part: `model.resize_token_embeddings(len(tokenizer))`
        ...
        **kwargs: Unpack[Qwen2_5_VLProcessorKwargs],
        ...
        Args:
            ...
            videos (`np.ndarray`, `torch.Tensor`, `List[np.ndarray]`, `List[torch.Tensor]`):
                The image or batch of videos to be prepared. Each video can be a 4D NumPy array or PyTorch
                tensor, or a nested list of 3D frames. Both channels-first and channels-last formats are supported.
            pointers (`LocalMemory`):
                Pointer memory input from Point3R, containing corresponding Qwen features.
            return_tensors (`str` or [`~utils.TensorType`], *optional*):
                If set, will return tensors of a particular framework. Acceptable values are:
                - `'tf'`: Return TensorFlow `tf.constant` objects.
                - `'pt'`: Return PyTorch `torch.Tensor` objects.
