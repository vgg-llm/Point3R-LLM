#!/bin/bash
# VSIBench Training Script for Qwen3-VL-4B with Memory Feature Addition
...
# Model Configuration
# ======================
DATASETS="vsibench_point3r" #or vstibench_point3r  # [DataArguments] VSIBench training data

# ======================
# Path Configuration
# ======================
MODEL_PATH="Qwen/Qwen3-VL-4B-Instruct"  # [ModelArguments] Pretrained model path
EXP_NAME="vsibench_Qwen3VL_4b_memfeat"
