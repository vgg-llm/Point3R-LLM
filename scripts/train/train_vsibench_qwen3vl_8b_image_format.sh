#!/bin/bash
# VSIBench + VSTIBench Training Script for Qwen3-VL-8B with Memory Feature Addition + Image Format Pointer Tokens
...
EXP_NAME="vsibench_Qwen3VL_8b_memfeat_32frame_video_image_format"
