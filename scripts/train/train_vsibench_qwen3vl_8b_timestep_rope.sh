#!/bin/bash
# VSIBench + VSTIBench Training Script for Qwen3-VL-8B with Memory Feature Addition + Pointer Timestamp RoPE
...
# Model Configuration
# ======================
DATASETS="vsibench_point3r" #or vstibench_point3r  # [DataArguments] VSIBench and VSTIBench training data

# ======================
# Path Configuration
# ======================
MODEL_PATH="Qwen/Qwen3-VL-8B-Instruct"  # [ModelArguments] Pretrained model path
EXP_NAME="vsibench_Qwen3VL_8b_memfeat_32frame_video_timestep_rope"
