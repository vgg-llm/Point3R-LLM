#!/bin/bash
# Complete QwenVL Training Launch Script with Full Parameter Documentation + Pointer Timestamp RoPE
...
# Model Configuration
# ======================
DATASETS="scanqa_point3r,sqa3d_point3r,beacon3d_point3r"                        # [DataArguments] Dataset with sampling rate; one of "scan2cap,scanrefer,scannet_det"

# ======================
# Path Configuration
# ======================
MODEL_PATH="Qwen/Qwen3-VL-8B-Instruct"  # [ModelArguments] Pretrained model path
EXP_NAME="3DQAs_point3r_Qwen3VL_8b_memfeat_timestep_rope"
