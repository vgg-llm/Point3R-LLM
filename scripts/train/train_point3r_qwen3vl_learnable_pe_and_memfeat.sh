...
# Exp: Learnable PE + Feature Addition
...
EXP_NAME="${DATASETS}_Qwen3VL_learnable_pe_and_memfeat"
...
torchrun --nproc_per_node=$NPROC_PER_NODE \
            ...
            --use_pointer_position_encoding True \
            --pointer_pos_hidden_dim 256 \
            --tune_pointer_position_encoder True \
