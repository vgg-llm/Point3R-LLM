#!/bin/bash
# Complete QwenVL Training Launch Script with Full Parameter Documentation + Image Format Pointer Tokens
...
EXP_NAME="${DATASETS}_Qwen3VL_8b_memfeat_image_format"
