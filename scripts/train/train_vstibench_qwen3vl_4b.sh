#!/bin/bash
# VSTIBench Training Script for Qwen3-VL-4B with Memory Feature Addition
...
# Model Configuration
# ======================
DATASETS="vstibench_point3r"  # [DataArguments] VSTIBench training data

# ======================
# Path Configuration
# ======================
MODEL_PATH="Qwen/Qwen3-VL-4B-Instruct"  # [ModelArguments] Pretrained model path
EXP_NAME="vstibench_Qwen3VL_4b_memfeat"
