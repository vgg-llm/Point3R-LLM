#!/bin/bash
# VSTIBench Point3R Evaluation Script for Qwen3-VL-8B
...
output_path=logs/vstibench_$(TZ="Asia/Shanghai" date "+%Y%m%d_%H%M%S")
model_path=./outputs/vstibench_Qwen3VL_8b_memfeat
...
echo "============================================="
echo "Evaluating VSTIBench Point3R"
