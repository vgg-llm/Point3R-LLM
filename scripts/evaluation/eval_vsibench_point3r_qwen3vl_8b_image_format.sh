#!/bin/bash
# VSIBench + VSTIBench Point3R Evaluation Script for Qwen3-VL-8B with Image Format Pointer Tokens
...
output_path=logs/vsibench_image_format_$(TZ="Asia/Shanghai" date "+%Y%m%d_%H%M%S")
model_path=./outputs/vsibench_Qwen3VL_8b_memfeat_32frame_video_image_format
...
merge_memory_feat=True,memory_fusion_method=add,pointer_format=image"
...
echo "============================================="
echo "Evaluating VSIBench Point3R (Image Format)"
