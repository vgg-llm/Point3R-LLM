...
model_path=./outputs/scan2cap_point3r_Qwen3VL_learnable_pe_and_memfeat
...
merge_memory_feat=True,memory_fusion_method=add,use_pointer_position_encoding=True,tune_pointer_position_encoder=True"
