#!/bin/bash
# VSIBench + VSTIBench Point3R Evaluation Script for Qwen3-VL-8B with Pointer Timestamp RoPE
...
output_path=logs/vsibench_timestep_rope_$(TZ="Asia/Shanghai" date "+%Y%m%d_%H%M%S")
model_path=./outputs/vsibench_Qwen3VL_8b_memfeat_32frame_video_timestep_rope
...
merge_memory_feat=True,memory_fusion_method=add,rope_mode=pointer_timestamp"
...
echo "============================================="
echo "Evaluating VSIBench Point3R (Pointer Timestamp RoPE)"
