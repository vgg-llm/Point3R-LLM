#!/bin/bash
# VSIBench Point3R Evaluation Script for Qwen3-VL-4B
...
output_path=logs/vsibench_4b_$(TZ="Asia/Shanghai" date "+%Y%m%d_%H%M%S")
model_path=./outputs/vsibench_Qwen3VL_4b_memfeat
...
echo "============================================="
echo "Evaluating VSIBench Point3R (4B model)"
