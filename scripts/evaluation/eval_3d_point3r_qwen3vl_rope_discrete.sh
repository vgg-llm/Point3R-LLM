...
model_path=./outputs/scan2cap_point3r_Qwen3VL_rope_discrete

model_args_str="pretrained=$model_path,use_flash_attention_2=true,max_num_frames=32,max_length=12800,use_pointer_memory=True,use_preprocessed_input=True,rope_mode=discrete,rope_position_range=128"
