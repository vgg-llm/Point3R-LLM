...
model_path=./outputs/scan2cap_point3r_Qwen3VL_rope_discrete_and_memfeat
...
merge_memory_feat=True,memory_fusion_method=add,rope_mode=discrete,rope_position_range=128"
