#!/bin/bash
#SBATCH --job-name="VSTI-bench Training and evaluation on pointer_memory_600patch (continuous RoPE)"
#SBATCH -o sbatch_log/vstibench_8b_600patch_rope_continuous.%j.out
...
export EXP_NAME="vstibench_8b_600patch_rope_continuous"
