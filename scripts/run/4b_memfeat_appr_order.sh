...
#SBATCH -o sbatch_log/appr_order_exp-4b-memfeat-spar.%j.out
...
export EXP_NAME="appr_order_spar_subset_memfeat_scannet_only_4B"
...
export POINTER_DIR_NAME="pointer_memory_qwen3vl_4B_timstamp"
