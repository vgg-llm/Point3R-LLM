#!/bin/bash
#SBATCH --job-name="Point3R-Qwen train on scanqa_revised"
#SBATCH -o sbatch_log/scanqa_point3r_revised_prompt.%j.out
...
export EXP_NAME="scanqa_point3r_revised_prompt"
export MODEL_PATH="Qwen/Qwen3-VL-8B-Instruct"
export DATASETS="scanqa_point3r"
...
# Evaluation
export BENCHMARKS="scanqa_point3r"
