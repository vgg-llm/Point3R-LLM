#!/bin/bash
#SBATCH --job-name=scan2cap_point3r_1_learnable_PE
#SBATCH -o sbatch_log/scan2cap_point3r_1_learnable_PE.%j.out
...
export EXP_NAME="scan2cap_point3r_1_learnable_PE"
