#!/bin/bash
#SBATCH --job-name=scan2cap_point3r_5_memfeat_4D_RoPE
#SBATCH -o sbatch_log/scan2cap_point3r_5_memfeat_4D_RoPE.%j.out
...
export EXP_NAME="scan2cap_point3r_5_memfeat_4D_RoPE"
