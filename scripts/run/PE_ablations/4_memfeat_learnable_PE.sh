#!/bin/bash
#SBATCH --job-name=scan2cap_point3r_4_memfeat_learnable_PE
#SBATCH -o sbatch_log/scan2cap_point3r_4_memfeat_learnable_PE.%j.out
...
export EXP_NAME="scan2cap_point3r_4_memfeat_learnable_PE"
...
export USE_POINTER_POSITION_ENCODING="True"
export TUNE_POINTER_POSITION_ENCODER="True"
