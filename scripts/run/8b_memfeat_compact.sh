...
#SBATCH -o sbatch_log/scan2cap_point3r_compact.%j.out
...
export EXP_NAME="scan2cap_point3r_Qwen3VL_8b_memfeat_compact"
...
export POINTER_DIR_NAME="pointer_memory_32frame_compact_wide"
