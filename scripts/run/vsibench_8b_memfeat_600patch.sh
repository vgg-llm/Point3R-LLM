#!/bin/bash
#SBATCH --job-name="VSI-bench Training and evaluation on pointer_memory_600patch"
#SBATCH -o sbatch_log/vsibench_memfeat_600patch.%j.out
...
export EXP_NAME="vsibench_memfeat_600patch"
