#!/bin/bash
#SBATCH --job-name="VSI-bench Training and evaluation on pointer_memory_600patch_4gpu (continuous RoPE)"
#SBATCH -o sbatch_log/vsibench_8b_600patch_rope_continuous_4gpu.%j.out
...
# Experiment: 8B with continuous (hierarchical) 3D RoPE on VSI-bench (no memory-feature fusion)

source venv/bin/activate
export NUM_PROCESSES=4

export EXP_NAME="vsibench_8b_600patch_rope_continuous_4gpu"
