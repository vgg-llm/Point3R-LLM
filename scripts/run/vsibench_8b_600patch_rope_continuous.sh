#!/bin/bash
#SBATCH --job-name="VSI-bench Training and evaluation on pointer_memory_600patch (continuous RoPE)"
#SBATCH -o sbatch_log/vsibench_8b_600patch_rope_continuous.%j.out
...
export EXP_NAME="vsibench_8b_600patch_rope_continuous"
