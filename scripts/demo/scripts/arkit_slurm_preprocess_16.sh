#!/bin/bash
# ARKitScenes preprocessing launcher for 16 parallel tasks
...
echo "=============================================="
echo ""
echo "Total scenes in dataset: 348"
...
for task_id in $(seq 0 $((TOTAL_TASKS - 1))); do
    ...
    sbatch --job-name=arkit_${task_id} \
...
echo "  - View logs:      tail -f logs/arkit_chunk_*.log"
echo "  - Cancel all:     scancel -u \$USER -n arkit"
echo ""
